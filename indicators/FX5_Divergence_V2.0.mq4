...
void CatchBullishDivergence(int shift)
  {
   ...
   if(lastTrough<0)return;
//----
   if(OsMA[currentTrough] > OsMA[lastTrough] && Low[currentTrough] < Low[lastTrough])
  // if(OsMA[currentTrough] > OsMA[lastTrough] && (Low[lastTrough] - Low[currentTrough]) >= 40*Pip)
     {
...
//----
   //if(OsMA[currentTrough] < OsMA[lastTrough] && Low[currentTrough] > Low[lastTrough])
   if(OsMA[currentTrough] < OsMA[lastTrough] && Low[currentTrough] - Low[lastTrough] >= 40*Pip)
     {
       bullishDivergence[currentTrough] = OsMA[currentTrough];
       //----
       if(drawDivergenceLines == true)
...
void CatchBearishDivergence(int shift)
  {
   ...
   if(lastPeak<0)return;  
//----
   if(OsMA[currentPeak] < OsMA[lastPeak] && High[currentPeak] > High[lastPeak])
   //if(OsMA[currentPeak] < OsMA[lastPeak] && High[currentPeak] - High[lastPeak] >= 40*Pip)
     {
...
//----
   //if(OsMA[currentPeak] > OsMA[lastPeak] && High[currentPeak] < High[lastPeak])
   if(OsMA[currentPeak] > OsMA[lastPeak] && High[lastPeak] - High[currentPeak] >=40*Pip )
     {
       bearishDivergence[currentPeak] = OsMA[currentPeak];
